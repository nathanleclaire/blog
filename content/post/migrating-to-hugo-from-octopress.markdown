...
For the life of me, I could not figure out how to get Hugo to stop generating mixed-case URLs (I just want lowercase), so I use the `lower` directive in a few places that I was making internal blog links (e.g. the [Archives page](https://nathanleclaire.com/post)).
