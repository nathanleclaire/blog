...
Additionally, Github's online markdown editor is **nice** (and fast), and I wouldn't mind writing whole articles on there from time to time.  If I could write using only Github and deploy on commit, I suddenly open a world of possibility.  Yes there is [Github Pages](https://help.github.com/articles/using-jekyll-with-pages), but if I decide to switch static site generators I am hosed (and I want to eventually finish migrating to [hugo](https://github.com/spf13/hugo)). 
